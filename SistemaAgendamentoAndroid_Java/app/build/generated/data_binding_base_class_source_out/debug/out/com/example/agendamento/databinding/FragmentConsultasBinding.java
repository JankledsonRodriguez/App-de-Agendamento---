...
public final class FragmentConsultasBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentConsultasBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentConsultasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentConsultasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_consultas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentConsultasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentConsultasBinding((ConstraintLayout) rootView, btnNovoAgendamento,
