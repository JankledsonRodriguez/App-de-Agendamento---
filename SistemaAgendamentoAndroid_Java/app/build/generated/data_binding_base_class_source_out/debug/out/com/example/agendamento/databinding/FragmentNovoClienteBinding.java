...
public final class FragmentNovoClienteBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentNovoClienteBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentNovoClienteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentNovoClienteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_novo_cliente, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentNovoClienteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNovoClienteBinding((ScrollView) rootView, btnSalvarCliente,
